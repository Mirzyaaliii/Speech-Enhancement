...
clean_path = '.../path/of/training_clean_data/';
noisy_path = '.../path/of/training_noisy_data/';
files = dir([clean_path,'/*.wav']);

% mkdir to save training data
mkdir '.../path/to_save/training_data' 'folder_name_training'
save_path = '.../path/to_save/training_data/folder_name_training/';
...
for i = 1:length(files)
    ...
    save([save_path,'Batch_',num2str(batch_ind)],'noisy_cent','clean_cent','Feat');
